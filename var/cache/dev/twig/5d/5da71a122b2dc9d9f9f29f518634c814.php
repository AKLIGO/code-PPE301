...
class __TwigTemplate_a156afc90f6bf6fdc4e6e7ff8f62d99b extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    <button class=\"btn btn-lg btn-primary\" type=\"submit\">
     ...
     <a href=\"";
        ...
        echo "\" class=\"btn btn-primary btn-lg my-3\">M'inscrire</a>
...
";
    ...
    {
        return array (  143 => 44,  136 => 39,  130 => 26,  122 => 21,  117 => 18,  109 => 15,  106 => 14,  104 => 13,  101 => 12,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous etes connecte(e) comme {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Me deconnecter</a>
        </div>
    {% endif %}
    ...
    <button class=\"btn btn-lg btn-primary\" type=\"submit\">
     ...
     <a href=\"{{ path('app_register')}}\" class=\"btn btn-primary btn-lg my-3\">M'inscrire</a>

</form>
{% endblock %}
", "security/login.html.twig", "C:\\xampp\\htdocs\\code_PPE300\\code_Ecommerce\\templates\\security\\login.html.twig");
    }
}
