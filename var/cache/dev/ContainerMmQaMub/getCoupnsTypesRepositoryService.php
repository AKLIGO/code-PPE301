 ...
 */
class getCoupnsTypesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoupnsTypesRepository' shared autowired service.
     *
     * @return \App\Repository\CoupnsTypesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoupnsTypesRepository.php';

        return $container->privates['App\\Repository\\CoupnsTypesRepository'] = new \App\Repository\CoupnsTypesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
