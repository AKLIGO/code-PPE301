 ...
 */
class getArticlesImagesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArticlesImagesRepository' shared autowired service.
     *
     * @return \App\Repository\ArticlesImagesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArticlesImagesRepository.php';

        return $container->privates['App\\Repository\\ArticlesImagesRepository'] = new \App\Repository\ArticlesImagesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
