 ...
 */
class getDetaileCommandesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetaileCommandesRepository' shared autowired service.
     *
     * @return \App\Repository\DetaileCommandesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetaileCommandesRepository.php';

        return $container->privates['App\\Repository\\DetaileCommandesRepository'] = new \App\Repository\DetaileCommandesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
